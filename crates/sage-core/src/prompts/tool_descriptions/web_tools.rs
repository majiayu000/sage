//! Web tool descriptions
//!
//! Contains descriptions for WebFetch and WebSearch tools.

/// WebFetch tool description
pub const WEB_FETCH: &str = r#"- Fetches content from a specified URL and processes it using an AI model
