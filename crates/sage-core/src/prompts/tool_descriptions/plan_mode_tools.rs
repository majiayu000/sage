//! Plan mode tool descriptions
//!
//! Contains descriptions for EnterPlanMode, ExitPlanMode, and AskUserQuestion tools.

/// Enter plan mode tool description
pub const ENTER_PLAN_MODE: &str = r#"Use this tool proactively when you're about to start a non-trivial implementation task. Getting user sign-off on your approach before writing code prevents wasted effort and ensures alignment. This tool transitions you into plan mode where you can explore the codebase and design an implementation approach for user approval.
...
pub const EXIT_PLAN_MODE: &str = r#"Use this tool when you are in plan mode and have finished writing your plan to the plan file and are ready for user approval.
...
pub const ASK_USER_QUESTION: &str = r#"Use this tool when you need to ask the user questions during execution. This allows you to:
